...
export default async function DashboardMain() {
  ...
  return (
    <div className="bg-white py-5 dark:bg-osc-200 rounded-lg ">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600 dark:text-celeste-100">
            Facil de usar
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-morado-400">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900 dark:text-white">
                  <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600 dark:bg-morado-500">
                    <feature.icon
                      className="h-6 w-6 text-white dark:text-morado-900"
                      aria-hidden="true"
                    />
                  </div>
                  {feature.name}
